package ir.adventure.observer.client.core.org.telegram.bot.services;
...
public class NotificationsService {
    ...
    public final int updatesInvalidated = notificationsCounter++;
    public final int needGetUpdates = notificationsCounter++;

    private NotificationsThread thread;
    ...
    public NotificationsService start(){
        if (!stated) {
            synchronized (this) {
