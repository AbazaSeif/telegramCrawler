...
import ir.adventure.observer.client.core.org.telegram.api.account.*;
...
import ir.adventure.observer.client.core.org.telegram.api.auth.codetype.TLCodeTypeCall;
import ir.adventure.observer.client.core.org.telegram.api.auth.codetype.TLCodeTypeFlashCall;
import ir.adventure.observer.client.core.org.telegram.api.auth.codetype.TLCodeTypeSms;
import ir.adventure.observer.client.core.org.telegram.api.auth.sentcodetype.TLSentCodeTypeApp;
import ir.adventure.observer.client.core.org.telegram.api.auth.sentcodetype.TLSentCodeTypeCall;
import ir.adventure.observer.client.core.org.telegram.api.auth.sentcodetype.TLSentCodeTypeFlashCall;
import ir.adventure.observer.client.core.org.telegram.api.auth.sentcodetype.TLSentCodeTypeSms;
import ir.adventure.observer.client.core.org.telegram.api.bot.TLBotCommand;
...
import ir.adventure.observer.client.core.org.telegram.api.bot.inlinemessage.*;
import ir.adventure.observer.client.core.org.telegram.api.bot.inlineresult.TLBotInlineMediaResult;
import ir.adventure.observer.client.core.org.telegram.api.bot.inlineresult.TLBotInlineResult;
import ir.adventure.observer.client.core.org.telegram.api.cdn.TLCdnConfig;
import ir.adventure.observer.client.core.org.telegram.api.cdn.TLCdnPublicKey;
import ir.adventure.observer.client.core.org.telegram.api.channel.TLChannelParticipants;
import ir.adventure.observer.client.core.org.telegram.api.channel.filters.TLChannelMessagesFilter;
import ir.adventure.observer.client.core.org.telegram.api.channel.filters.TLChannelMessagesFilterEmpty;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.*;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.filters.TLChannelParticipantsFilterAdmins;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.filters.TLChannelParticipantsFilterBots;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.filters.TLChannelParticipantsFilterKicked;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.filters.TLChannelParticipantsFilterRecent;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.role.TLChannelParticipantRoleEditor;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.role.TLChannelParticipantRoleEmpty;
import ir.adventure.observer.client.core.org.telegram.api.channel.participants.role.TLChannelParticipantRoleModerator;
import ir.adventure.observer.client.core.org.telegram.api.chat.TLChat;
import ir.adventure.observer.client.core.org.telegram.api.chat.TLChatEmpty;
import ir.adventure.observer.client.core.org.telegram.api.chat.TLChatForbidden;
import ir.adventure.observer.client.core.org.telegram.api.chat.TLChatFull;
import ir.adventure.observer.client.core.org.telegram.api.chat.channel.TLChannel;
import ir.adventure.observer.client.core.org.telegram.api.chat.channel.TLChannelForbidden;
import ir.adventure.observer.client.core.org.telegram.api.chat.channel.TLChannelFull;
import ir.adventure.observer.client.core.org.telegram.api.chat.invite.TLChatInvite;
import ir.adventure.observer.client.core.org.telegram.api.chat.invite.TLChatInviteAlready;
import ir.adventure.observer.client.core.org.telegram.api.chat.invite.TLChatInviteEmpty;
import ir.adventure.observer.client.core.org.telegram.api.chat.invite.TLChatInviteExported;
import ir.adventure.observer.client.core.org.telegram.api.chat.participant.chatparticipant.TLChatParticipant;
import ir.adventure.observer.client.core.org.telegram.api.chat.participant.chatparticipant.TLChatParticipantAdmin;
import ir.adventure.observer.client.core.org.telegram.api.chat.participant.chatparticipant.TLChatParticipantCreator;
import ir.adventure.observer.client.core.org.telegram.api.chat.participant.chatparticipants.TLChatParticipants;
import ir.adventure.observer.client.core.org.telegram.api.chat.participant.chatparticipants.TLChatParticipantsForbidden;
import ir.adventure.observer.client.core.org.telegram.api.chat.photo.TLChatPhoto;
import ir.adventure.observer.client.core.org.telegram.api.chat.photo.TLChatPhotoEmpty;
...
import ir.adventure.observer.client.core.org.telegram.api.contact.link.TLContactLinkContact;
import ir.adventure.observer.client.core.org.telegram.api.contact.link.TLContactLinkHasPhone;
import ir.adventure.observer.client.core.org.telegram.api.contact.link.TLContactLinkNone;
import ir.adventure.observer.client.core.org.telegram.api.contact.link.TLContactLinkUnknown;
import ir.adventure.observer.client.core.org.telegram.api.contacts.*;
import ir.adventure.observer.client.core.org.telegram.api.contacts.blocked.TLBlocked;
import ir.adventure.observer.client.core.org.telegram.api.contacts.blocked.TLBlockedSlice;
import ir.adventure.observer.client.core.org.telegram.api.contacts.toppeers.TLContactsTopPeers;
import ir.adventure.observer.client.core.org.telegram.api.contacts.toppeers.TLContactsTopPeersNotModified;
import ir.adventure.observer.client.core.org.telegram.api.decryptedmessage.*;
...
import ir.adventure.observer.client.core.org.telegram.api.document.TLDocumentEmpty;
import ir.adventure.observer.client.core.org.telegram.api.document.attribute.*;
import ir.adventure.observer.client.core.org.telegram.api.draft.TLDraftMessage;
import ir.adventure.observer.client.core.org.telegram.api.draft.TLDraftMessageEmpty;
import ir.adventure.observer.client.core.org.telegram.api.encrypted.chat.*;
import ir.adventure.observer.client.core.org.telegram.api.encrypted.file.TLEncryptedFile;
import ir.adventure.observer.client.core.org.telegram.api.encrypted.file.TLEncryptedFileEmpty;
import ir.adventure.observer.client.core.org.telegram.api.encrypted.message.TLEncryptedMessage;
import ir.adventure.observer.client.core.org.telegram.api.encrypted.message.TLEncryptedMessageService;
import ir.adventure.observer.client.core.org.telegram.api.file.location.TLFileLocation;
import ir.adventure.observer.client.core.org.telegram.api.file.location.TLFileLocationUnavailable;
import ir.adventure.observer.client.core.org.telegram.api.foundgif.TLFoundGif;
import ir.adventure.observer.client.core.org.telegram.api.foundgif.TLFoundGifCached;
import ir.adventure.observer.client.core.org.telegram.api.functions.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.account.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.auth.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.bots.TLRequestBotsSendCustomRequest;
import ir.adventure.observer.client.core.org.telegram.api.functions.channels.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.contacts.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.help.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.messages.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.payments.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.phone.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.photos.TLRequestPhotosDeletePhotos;
import ir.adventure.observer.client.core.org.telegram.api.functions.photos.TLRequestPhotosGetUserPhotos;
import ir.adventure.observer.client.core.org.telegram.api.functions.photos.TLRequestPhotosUpdateProfilePhoto;
import ir.adventure.observer.client.core.org.telegram.api.functions.photos.TLRequestPhotosUploadProfilePhoto;
...
import ir.adventure.observer.client.core.org.telegram.api.functions.upload.*;
import ir.adventure.observer.client.core.org.telegram.api.functions.users.TLRequestUsersGetFullUser;
import ir.adventure.observer.client.core.org.telegram.api.functions.users.TLRequestUsersGetUsers;
import ir.adventure.observer.client.core.org.telegram.api.game.TLGame;
import ir.adventure.observer.client.core.org.telegram.api.geo.point.TLGeoPoint;
import ir.adventure.observer.client.core.org.telegram.api.geo.point.TLGeoPointEmpty;
import ir.adventure.observer.client.core.org.telegram.api.help.*;
...
import ir.adventure.observer.client.core.org.telegram.api.input.bot.inlinemessage.*;
import ir.adventure.observer.client.core.org.telegram.api.input.bot.inlineresult.TLInputBotInlineResult;
import ir.adventure.observer.client.core.org.telegram.api.input.bot.inlineresult.TLInputBotInlineResultDocument;
import ir.adventure.observer.client.core.org.telegram.api.input.bot.inlineresult.TLInputBotInlineResultGame;
import ir.adventure.observer.client.core.org.telegram.api.input.bot.inlineresult.TLInputBotInlineResultPhoto;
import ir.adventure.observer.client.core.org.telegram.api.input.chat.TLInputChannel;
import ir.adventure.observer.client.core.org.telegram.api.input.chat.TLInputChannelEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.chat.photo.TLInputChatPhoto;
import ir.adventure.observer.client.core.org.telegram.api.input.chat.photo.TLInputChatPhotoEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.chat.photo.TLInputChatUploadedPhoto;
import ir.adventure.observer.client.core.org.telegram.api.input.document.TLInputDocument;
import ir.adventure.observer.client.core.org.telegram.api.input.document.TLInputDocumentEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.encrypted.TLInputEncryptedChat;
import ir.adventure.observer.client.core.org.telegram.api.input.encrypted.file.TLInputEncryptedFile;
import ir.adventure.observer.client.core.org.telegram.api.input.encrypted.file.TLInputEncryptedFileBigUploaded;
import ir.adventure.observer.client.core.org.telegram.api.input.encrypted.file.TLInputEncryptedFileEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.encrypted.file.TLInputEncryptedFileUploaded;
import ir.adventure.observer.client.core.org.telegram.api.input.encrypted.file.location.TLInputEncryptedFileLocation;
import ir.adventure.observer.client.core.org.telegram.api.input.file.TLInputFile;
import ir.adventure.observer.client.core.org.telegram.api.input.file.TLInputFileBig;
import ir.adventure.observer.client.core.org.telegram.api.input.filelocation.TLInputDocumentFileLocation;
import ir.adventure.observer.client.core.org.telegram.api.input.filelocation.TLInputFileLocation;
import ir.adventure.observer.client.core.org.telegram.api.input.game.TLInputGameId;
import ir.adventure.observer.client.core.org.telegram.api.input.game.TLInputGameShortName;
import ir.adventure.observer.client.core.org.telegram.api.input.geopoint.TLInputGeoPoint;
import ir.adventure.observer.client.core.org.telegram.api.input.geopoint.TLInputGeoPointEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.media.*;
import ir.adventure.observer.client.core.org.telegram.api.input.messages.entity.TLInputMessageEntityMentionName;
import ir.adventure.observer.client.core.org.telegram.api.input.messages.filter.*;
import ir.adventure.observer.client.core.org.telegram.api.input.notify.TLInputNotifyAll;
import ir.adventure.observer.client.core.org.telegram.api.input.notify.TLInputNotifyChats;
import ir.adventure.observer.client.core.org.telegram.api.input.notify.TLInputNotifyPeer;
import ir.adventure.observer.client.core.org.telegram.api.input.notify.TLInputNotifyUsers;
...
import ir.adventure.observer.client.core.org.telegram.api.input.paymentapi.paymentcredentials.TLInputPaymentCredentials;
import ir.adventure.observer.client.core.org.telegram.api.input.paymentapi.paymentcredentials.TLInputPaymentCredentialsSaved;
...
import ir.adventure.observer.client.core.org.telegram.api.input.peer.notify.events.TLInputPeerNotifyEventsAll;
import ir.adventure.observer.client.core.org.telegram.api.input.peer.notify.events.TLInputPeerNotifyEventsEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.phonecall.TLInputPhoneCall;
import ir.adventure.observer.client.core.org.telegram.api.input.photo.TLInputPhoto;
import ir.adventure.observer.client.core.org.telegram.api.input.photo.TLInputPhotoEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.privacy.inputprivacykey.TLInputPrivacyKeyChatInvite;
import ir.adventure.observer.client.core.org.telegram.api.input.privacy.inputprivacykey.TLInputPrivacyKeyPhoneCall;
import ir.adventure.observer.client.core.org.telegram.api.input.privacy.inputprivacykey.TLInputPrivacyKeyStatusTimestamp;
import ir.adventure.observer.client.core.org.telegram.api.input.privacy.inputprivacyrule.*;
import ir.adventure.observer.client.core.org.telegram.api.input.reportspamreason.TLReportSpamReasonOther;
import ir.adventure.observer.client.core.org.telegram.api.input.reportspamreason.TLReportSpamReasonPornography;
import ir.adventure.observer.client.core.org.telegram.api.input.reportspamreason.TLReportSpamReasonSpam;
import ir.adventure.observer.client.core.org.telegram.api.input.reportspamreason.TLReportSpamReasonViolence;
import ir.adventure.observer.client.core.org.telegram.api.input.sticker.media.TLInputStickeredMediaDocument;
import ir.adventure.observer.client.core.org.telegram.api.input.sticker.media.TLInputStickeredMediaPhoto;
import ir.adventure.observer.client.core.org.telegram.api.input.sticker.set.TLInputStickerSetEmpty;
import ir.adventure.observer.client.core.org.telegram.api.input.sticker.set.TLInputStickerSetId;
import ir.adventure.observer.client.core.org.telegram.api.input.sticker.set.TLInputStickerSetShortName;
import ir.adventure.observer.client.core.org.telegram.api.input.user.TLInputUser;
import ir.adventure.observer.client.core.org.telegram.api.input.user.TLInputUserEmpty;
...
import ir.adventure.observer.client.core.org.telegram.api.keyboard.button.*;
import ir.adventure.observer.client.core.org.telegram.api.keyboard.replymarkup.TLReplayInlineKeyboardMarkup;
import ir.adventure.observer.client.core.org.telegram.api.keyboard.replymarkup.TLReplayKeyboardForceReply;
import ir.adventure.observer.client.core.org.telegram.api.keyboard.replymarkup.TLReplayKeyboardHide;
import ir.adventure.observer.client.core.org.telegram.api.keyboard.replymarkup.TLReplayKeyboardMarkup;
import ir.adventure.observer.client.core.org.telegram.api.message.*;
import ir.adventure.observer.client.core.org.telegram.api.message.action.*;
import ir.adventure.observer.client.core.org.telegram.api.message.entity.*;
import ir.adventure.observer.client.core.org.telegram.api.message.media.*;
import ir.adventure.observer.client.core.org.telegram.api.messages.*;
import ir.adventure.observer.client.core.org.telegram.api.messages.chats.TLMessagesChats;
import ir.adventure.observer.client.core.org.telegram.api.messages.chats.TLMessagesChatsSlice;
import ir.adventure.observer.client.core.org.telegram.api.messages.dhconfig.TLDhConfig;
import ir.adventure.observer.client.core.org.telegram.api.messages.dhconfig.TLDhConfigNotModified;
import ir.adventure.observer.client.core.org.telegram.api.messages.dialogs.TLDialogs;
import ir.adventure.observer.client.core.org.telegram.api.messages.dialogs.TLDialogsSlice;
import ir.adventure.observer.client.core.org.telegram.api.messages.savedgifs.TLSavedGifs;
import ir.adventure.observer.client.core.org.telegram.api.messages.savedgifs.TLSavedGifsNotModified;
import ir.adventure.observer.client.core.org.telegram.api.messages.sentencrypted.TLSentEncryptedFile;
import ir.adventure.observer.client.core.org.telegram.api.messages.sentencrypted.TLSentEncryptedMessage;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.*;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.featured.TLMessagesFeaturedStickers;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.featured.TLMessagesFeaturedStickersNotModified;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.recent.TLMessagesRecentStickers;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.recent.TLMessagesRecentStickersNotModified;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.setintallresult.TLMessagesStickerSetInstallResultArchive;
import ir.adventure.observer.client.core.org.telegram.api.messages.stickers.setintallresult.TLMessagesStickerSetInstallResultSuccess;
import ir.adventure.observer.client.core.org.telegram.api.notify.peer.TLNotifyAll;
import ir.adventure.observer.client.core.org.telegram.api.notify.peer.TLNotifyChats;
import ir.adventure.observer.client.core.org.telegram.api.notify.peer.TLNotifyPeer;
import ir.adventure.observer.client.core.org.telegram.api.notify.peer.TLNotifyUsers;
import ir.adventure.observer.client.core.org.telegram.api.page.TLPageFull;
import ir.adventure.observer.client.core.org.telegram.api.page.TLPagePart;
import ir.adventure.observer.client.core.org.telegram.api.page.block.*;
import ir.adventure.observer.client.core.org.telegram.api.paymentapi.*;
...
import ir.adventure.observer.client.core.org.telegram.api.paymentapi.payments.result.TLPaymentsPaymentResult;
import ir.adventure.observer.client.core.org.telegram.api.paymentapi.payments.result.TLPaymentsPaymentVerificationNeeded;
import ir.adventure.observer.client.core.org.telegram.api.paymentapi.savedcredentails.TLPaymentSavedCredentialsCard;
import ir.adventure.observer.client.core.org.telegram.api.peer.TLPeerChannel;
import ir.adventure.observer.client.core.org.telegram.api.peer.TLPeerChat;
import ir.adventure.observer.client.core.org.telegram.api.peer.TLPeerSettings;
import ir.adventure.observer.client.core.org.telegram.api.peer.TLPeerUser;
import ir.adventure.observer.client.core.org.telegram.api.peer.notify.events.TLPeerNotifyEventsAll;
import ir.adventure.observer.client.core.org.telegram.api.peer.notify.events.TLPeerNotifyEventsEmpty;
import ir.adventure.observer.client.core.org.telegram.api.peer.notify.settings.TLPeerNotifySettings;
import ir.adventure.observer.client.core.org.telegram.api.peer.notify.settings.TLPeerNotifySettingsEmpty;
...
import ir.adventure.observer.client.core.org.telegram.api.phone.call.*;
import ir.adventure.observer.client.core.org.telegram.api.phone.call.discardreason.TLPhoneCallDiscardReasonBusy;
import ir.adventure.observer.client.core.org.telegram.api.phone.call.discardreason.TLPhoneCallDiscardReasonDisconnect;
import ir.adventure.observer.client.core.org.telegram.api.phone.call.discardreason.TLPhoneCallDiscardReasonHangup;
import ir.adventure.observer.client.core.org.telegram.api.phone.call.discardreason.TLPhoneCallDiscardReasonMissed;
import ir.adventure.observer.client.core.org.telegram.api.photo.TLPhoto;
import ir.adventure.observer.client.core.org.telegram.api.photo.TLPhotoEmpty;
import ir.adventure.observer.client.core.org.telegram.api.photo.size.TLPhotoCachedSize;
import ir.adventure.observer.client.core.org.telegram.api.photo.size.TLPhotoSize;
import ir.adventure.observer.client.core.org.telegram.api.photo.size.TLPhotoSizeEmpty;
import ir.adventure.observer.client.core.org.telegram.api.photos.TLPhotos;
import ir.adventure.observer.client.core.org.telegram.api.photos.TLPhotosPhoto;
import ir.adventure.observer.client.core.org.telegram.api.photos.TLPhotosSlice;
import ir.adventure.observer.client.core.org.telegram.api.privacy.privacykey.TLPrivacyKeyChatInvite;
import ir.adventure.observer.client.core.org.telegram.api.privacy.privacykey.TLPrivacyKeyPhoneCall;
import ir.adventure.observer.client.core.org.telegram.api.privacy.privacykey.TLPrivacyKeyStatusTimestamp;
import ir.adventure.observer.client.core.org.telegram.api.privacy.privacyrule.*;
import ir.adventure.observer.client.core.org.telegram.api.richtext.*;
import ir.adventure.observer.client.core.org.telegram.api.sendmessage.action.*;
...
import ir.adventure.observer.client.core.org.telegram.api.sticker.stickersetconvered.TLStickerSetCovered;
import ir.adventure.observer.client.core.org.telegram.api.sticker.stickersetconvered.TLStickerSetMultiCovered;
import ir.adventure.observer.client.core.org.telegram.api.storage.file.*;
import ir.adventure.observer.client.core.org.telegram.api.toppeer.TLTopPeer;
import ir.adventure.observer.client.core.org.telegram.api.toppeer.TLTopPeerCategoryPeers;
import ir.adventure.observer.client.core.org.telegram.api.toppeer.category.*;
import ir.adventure.observer.client.core.org.telegram.api.update.*;
import ir.adventure.observer.client.core.org.telegram.api.update.encrypted.TLUpdateEncryptedChatTyping;
import ir.adventure.observer.client.core.org.telegram.api.update.encrypted.TLUpdateEncryptedMessagesRead;
import ir.adventure.observer.client.core.org.telegram.api.update.encrypted.TLUpdateEncryption;
import ir.adventure.observer.client.core.org.telegram.api.update.encrypted.TLUpdateNewEncryptedMessage;
import ir.adventure.observer.client.core.org.telegram.api.updates.*;
...
import ir.adventure.observer.client.core.org.telegram.api.updates.difference.TLDifferenceEmpty;
...
import ir.adventure.observer.client.core.org.telegram.api.upload.cdn.TLCdnFileReuploadNeeded;
...
import ir.adventure.observer.client.core.org.telegram.api.user.TLUserEmpty;
import ir.adventure.observer.client.core.org.telegram.api.user.TLUserFull;
import ir.adventure.observer.client.core.org.telegram.api.user.profile.photo.TLUserProfilePhoto;
import ir.adventure.observer.client.core.org.telegram.api.user.profile.photo.TLUserProfilePhotoEmpty;
import ir.adventure.observer.client.core.org.telegram.api.user.status.*;
import ir.adventure.observer.client.core.org.telegram.api.wallpaper.TLWallPaper;
import ir.adventure.observer.client.core.org.telegram.api.wallpaper.TLWallPaperSolid;
import ir.adventure.observer.client.core.org.telegram.api.webpage.TLWebPage;
import ir.adventure.observer.client.core.org.telegram.api.webpage.TLWebPageEmpty;
import ir.adventure.observer.client.core.org.telegram.api.webpage.TLWebPageNotModified;
import ir.adventure.observer.client.core.org.telegram.api.webpage.TLWebPagePending;
...
public class TLApiContext extends TLContext {
    ...
    private void addApiLayer26() {
        ...
        registerClass(ir.adventure.observer.client.core.org.telegram.api.auth.TLAuthorization.CLASS_ID, ir.adventure.observer.client.core.org.telegram.api.auth.TLAuthorization.class);
    ...
    private void addApiLayer38() {
        ...
        registerClass(ir.adventure.observer.client.core.org.telegram.api.channel.TLChannelParticipant.CLASS_ID, ir.adventure.observer.client.core.org.telegram.api.channel.TLChannelParticipant.class);
