package ir.adventure.observer.client.core.org.telegram.bot.kernel.engine;

import ir.adventure.observer.client.core.org.telegram.api.TLConfig;
import ir.adventure.observer.client.core.org.telegram.api.TLDcOption;
import ir.adventure.observer.client.core.org.telegram.api.auth.TLAuthorization;
...
import ir.adventure.observer.client.core.org.telegram.bot.kernel.engine.storage.TLDcInfo;
import ir.adventure.observer.client.core.org.telegram.bot.kernel.engine.storage.TLKey;
import ir.adventure.observer.client.core.org.telegram.bot.kernel.engine.storage.TLLastKnownSalt;
import ir.adventure.observer.client.core.org.telegram.bot.kernel.engine.storage.TLStorage;
...
public class MemoryApiState extends TLPersistence<TLStorage> implements AbsApiState {
    ...
    public synchronized void updateSettings(TLConfig config) {
        ...
        for (TLDcOption option : config.getDcOptions()) {
            ...
            ir.adventure.observer.client.core.org.telegram.tl.TLVector<TLDcInfo> var = getObj().getDcInfos();
